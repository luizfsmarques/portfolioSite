...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="div-body">
            ...
            <h1 class="titulo-principal">Projetos profissionais</h1>
                ...
                <main class="conteudo-principal">
                    ...
                    {   
                        ...
                        {
                    ?>          <?php
                            if($projetos->getTipo() == "profissional")
                            {
                            ?>
                                <section class="card">
                                    <div class="imagem-box">
                                        <img class="imagem" src="/public_html/public/img/projetos/<?php echo $projetos->getImagem(); ?>">
                                    </div>
