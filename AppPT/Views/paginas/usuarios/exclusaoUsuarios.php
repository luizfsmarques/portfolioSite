...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="/public_html/public/css/usuarios/exclusaoUsuarios.css" type="text/css">
            ...
            <main class="conteudo-principal">
                ...
                <div class="organiza-incluir-excluir-projetos">
                    ...
                    <section class="incluir-projetos">
                        ...
                        <form action="<?php echo APP_HOST; ?>/usuarios/excluir/" method="POST" >
                            <div>
                                <input type="hidden" name="id" value="<?php echo $viewVar['usuariosExclusao']->getId(); ?>" >
                                <p> Deseja realmente excluir o usuário: <?php echo $viewVar["usuariosExclusao"]->getUsuario(); ?>? </p>
                                <P> O e-mail é: <?php echo $viewVar['usuariosExclusao']->getEmail(); ?>...</p>
                            </div>
                            <?php
                            if($convidado == true)
                            {
                            ?>  
                                <div>
                                    <p>Permissão para excluir usuário está negada!</p>
                                </div>
                            <?php
                            }else
                            {
