...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="/public_html/public/css/projetos/exclusaoAdmin.css" type="text/css">
            ...
            <main class="conteudo-principal">
                ...
                <div class="organiza-incluir-excluir-projetos">
                    ...
                    <section class="incluir-projetos">
                        ...
                        <form action="<?php echo APP_HOST; ?>/projetos/excluir/" method="POST" class="form-projetos" enctype="multipart/form-data">
                            <div>
                                <input type="hidden" name="id" value="<?php echo $viewVar['projetosExclusao']->getId(); ?>" >
                                <p> Deseja realmente excluir o projeto: <?php echo $viewVar["projetosExclusao"]->getNome(); ?>? </p>
                                <P> Ele é do tipo: <?php echo $viewVar['projetosExclusao']->getTipo(); ?>.</p>
                            </div>
                            <?php
                            if($convidado == true)
                            {
                            ?>  
                                <div>
                                    <p>Permissão para excluir projeto está negada!</p>
                                </div>
                            <?php
                            }else
                            {
