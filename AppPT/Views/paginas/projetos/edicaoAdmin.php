...
<html lang="pt-br">
    <head>
        ...
        <title>Administrador - Edição</title>
        ...
        <div class="div-body">
            ...
            <main class="conteudo-principal">
                    ...
                    <section class="incluir-projetos">
                        ...
                        <form action="<?php echo APP_HOST; ?>/projetos/atualizar" method="POST" class="form-projetos" enctype="multipart/form-data">
    
                            <h3>Incluir projetos</h3>

                            <input id="id" type="hidden" name="id" required value="<?php echo $viewVar['projetosEdicao']->getId(); ?>">
                            ...
                            <input type="text" id="nome-projeto" name="nome"required value="<?php echo $viewVar['projetosEdicao']->getNome(); ?>" >
                            <br>
    
                            <label for="tecnologias">Tecnologias usadas:</label> <br>
                            <input type="text" id="tecnologias" name="tecnologia" required value="<?php echo $viewVar['projetosEdicao']->getTecnologia(); ?>">
                            <br>
                            ...
                            <input type="text" id="link-projeto" name="link" value="<?php echo $viewVar['projetosEdicao']->getLink(); ?>" required>
                            <br>

                            <label for="descricao">Descrição:</label> <br>
                            <textarea id="descricao" name="descricao" maxlength="1000" required><?php echo $viewVar['projetosEdicao']->getDescricao(); ?></textarea>
                            <br>
                            ...
                            {
                            ?>
                                <p>Permissão para atualizar projeto está negada!</p>
                            <?php
                            }else
                            {
                            ?>
