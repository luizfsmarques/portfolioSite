            ...
            <main class="conteudo-principal">
                ...
                <div class="organiza-incluir-excluir-projetos">
                    ...
                    <section class="incluir-projetos">
                        ...
                        <form action="<?php echo APP_HOST; ?>/contact/delete/" method="POST" class="form-projetos" enctype="multipart/form-data">
                            
                            <div>
                                <input type="hidden" name="id" value="<?php echo $viewVar['contactDelete']->getId(); ?>" >
                                <p> Do you really want to delete the message of: <?php echo $viewVar["contactDelete"]->getNome(); ?>? </p>
                                <P> The subject matter is: <?php echo $viewVar['contactDelete']->getAssunto(); ?>...</p>
                            </div>
                            <?php
                            if($guest == true)
                            {
                            ?>  
                                <div>
                                    <p>Permission to delete contact is denied!</p>
                                </div>
                            <?php
                            }else{
                            ?>
