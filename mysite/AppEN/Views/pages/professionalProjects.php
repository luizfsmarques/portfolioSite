...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/public_html/public/css/projetosprof2.css" type="text/css">
        ...
        <?php
            ...
            if( (isset($_SESSION['user'])==true ) && (isset($_SESSION['password'])==true))
            {
                ...
                header("Location:" . APP_HOST . "/professionalProjects");
            }
        ?>
    ...
    <body>
        ...
        <div class="div-body">
            ...
            <h1 class="titulo-principal">Professional projects</h1>
                ...
                <main class="conteudo-principal">
                    ...
                    {   
                        foreach($viewVar['projects'] as $projects)
                        {
                    ?>          
                            <?php
                            if($projects->getTipo() == "profissional")
                            {
                            ?>
                                <section class="card">
