...
<html lang="en">
    ...
    <body>
        ...
        <nav class="menu-escondido-links">
                ...
                <ul>
                    <li> <a href="<?php echo APP_HOST; ?>/resume"> Résumé </a> </li>
                </ul>
                 <ul>
            ...
            <main class="conteudo-principal">
                ...
                <div class="organiza-incluir-excluir-projetos">
                    ...
                    <section class="incluir-projetos">
                        ...
                        <form action="<?php echo APP_HOST; ?>/users/delete/" method="POST" >
                            <div>
                                <input type="hidden" name="id" value="<?php echo $viewVar['usersDelete']->getId(); ?>" >
                                <p> Do you really want to delete the user: <?php echo $viewVar["usersDelete"]->getUsuario(); ?>? </p>
                                <P> The e-mail: <?php echo $viewVar['usersDelete']->getEmail(); ?>...</p>
                            </div>
                            <?php
                            if($guest == true)
                            {
                            ?>  
                                <div>
                                    <p>Permission to delete the user is denied!</p>
                                </div>
                            <?php
                            }else
                            {
                            ...
                            <a id="voltar-btn" href="<?php echo APP_HOST; ?>/users/mainUsers">Previous page</a>
