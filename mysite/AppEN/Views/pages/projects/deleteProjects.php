            ...
            <main class="conteudo-principal">
                ...
                <div class="organiza-incluir-excluir-projetos">
                    ...
                    <section class="incluir-projetos">
                        ...
                        <form action="<?php echo APP_HOST; ?>/projects/delete" method="POST" class="form-projetos" enctype="multipart/form-data">
                            <div>
                                <input type="hidden" name="id" value="<?php echo $viewVar['projectsDelete']->getId(); ?>" >
                                <p> Do you really want to delete the project: <?php echo $viewVar["projectsDelete"]->getNome(); ?>? </p>
                                <P> Type of: <?php echo $viewVar['projectsDelete']->getTipo(); ?>.</p>
                            </div>
                            <?php
                            if($guest == true)
                            {
                            ?>  
                                <div>
                                    <p>Permission to delete project is denied!</p>
                                </div>
                            <?php
                            }else
                            {
